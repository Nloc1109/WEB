var scrolltotop = {
    ...
    controlHTML: '<button class="btn btn-primary"><i class="fas fa-long-arrow-alt-up"></i></button>',
    controlattrs: {
        offsetx: 5,
        offsety: 5
    },
    ...
    scrollup: function() {
        ...
        t = "string" == typeof t && 1 == $("#" + t).length ? $("#" + t).offset().top : 0,
        this.$body.animate({
            scrollTop: t
    ...
    init: function() {
        $(document).ready(function(t) {
            ...
            o.$control = t('<div id="topcontrol" class="gototop">' + o.controlHTML + "</div>").css({
